...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["update_expense"])) {
    ...
    var_dump($_POST["expenseUpdateCategory"]) ; 
      $update_expense = new Expense($_SESSION["expense_info"][0],$_SESSION["expense_info"][1],$_SESSION["expense_info"][2],$_SESSION["expense_info"][3],$_SESSION["expense_info"][4],$_SESSION["expense_info"][5]);
